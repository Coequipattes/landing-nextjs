...
export const serverEnv = {
  // Envoi d'emails
  get contactEmailFrom() {
    return required("CONTACT_EMAIL_FROM", process.env.CONTACT_EMAIL_FROM);
  },
  get contactEmailTo() {
    return required("CONTACT_EMAIL_TO", process.env.CONTACT_EMAIL_TO);
  },
  get resendApiKey() {
  ...
  get googlePlacesApiKey() {
    return required("GOOGLE_PLACES_API_KEY", process.env.GOOGLE_PLACES_API_KEY);
  },
  get googlePlaceId() {
    return required("GOOGLE_PLACE_ID", process.env.GOOGLE_PLACE_ID);
  },
