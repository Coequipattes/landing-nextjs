...
// Variante E — comme la B, mais étapes et récompenses interverties :
// titre → étapes → double récompense (juste au-dessus du footer).
...
export const Route = createFileRoute("/post-parrainage-e")({
  server: {
    handlers: {
      GET: async () => {
